...
import cat.cristina.pep.jbcnconffeedback.fragment.ChooseTalkFragment.ChooseTalkFragmentListener
...
class MyTalkRecyclerViewAdapter(
        ...
        private val mListener: ChooseTalkFragmentListener?,
    ...
    init {
        mOnClickListener = View.OnClickListener { v ->
            ...
            mListener?.onChooseTalkFragmentClickTalk(item)
        }

        mOnLongClickListener = View.OnLongClickListener { v ->
            val item = v.tag as TalkItem
            mListener?.onChooseTalkFragmentLongClickTalk(item)
            true
        }
