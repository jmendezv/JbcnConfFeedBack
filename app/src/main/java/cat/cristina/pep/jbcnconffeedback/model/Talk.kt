...
data class Talk (
        @DatabaseField(generatedId = true, columnName = ID_FIELD_NAME_AUTOGENERATED, dataType = DataType.INTEGER, canBeNull = false, unique = true)
        val ident: Int = 0,

        @DatabaseField(columnName = ID_FIELD_NAME, dataType = DataType.INTEGER, canBeNull = false, unique = true)
        val id: Int = 0,
...
//        var tags: Array<String>? = null,
    ...
    companion object TalkData {
        ...
        const val ID_FIELD_NAME_AUTOGENERATED = "_id"
